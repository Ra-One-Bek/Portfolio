export default function ContactSection() {
  const icons = [
    { id: 1, title: "Whatsapp", img: "/img/contact/whatsapp-ic.webp" },
    { id: 2, title: "Telegram", img: "/img/contact/telegram-ic.png" },
    { id: 3, title: "Instagram", img: "/img/contact/instagram-ic.webp" },
  ];
